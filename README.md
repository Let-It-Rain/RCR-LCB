...
- [x] Глава 7
- [x] Глава 8
- [x] Глава 9 (Наш ручной перевод без шуток, готово 2 части из 3х)
...
- Шаг 6: Если нет папки "Lang", нужно создать ее. Затем внутри создать еще одну папку с именем RCR
